...
{
    const char* pszTimestamp = "Vulpfin activated. TG11 engaged. Fop pawb confirmed. Blockchain go brrr~ - May 2026";
    const CScript genesisOutputScript = CScript() << ParseHex("04274d8ad58090085b39022b0e7b77436ac534e0fe510436df0baea5e7b701c5476fc8b9aeabfc50db1705e33508220efcb8e4fbd7f7954125107228f2af243104") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(pszMainnetTimestamp, mainnetGenesisOutputScript, 1779175113, 741932, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x00000a349706b44dfb0dbb06c91579ebcd50ca8d0efc84ce8aef2c215cd674c0"));
        assert(genesis.hashMerkleRoot == uint256S("0x4c8f12550227d3ebf195dc355db66630b69d8c788f862346b86167ee1916c29f"));
        ...
        vSeeds.emplace_back("seed1.tg11.org");
        vSeeds.emplace_back("seed2.tg11.org");
        vSeeds.emplace_back("seed3.tg11.org");
        ...
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x54, 0x47, 0x11};
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x54, 0x47, 0x22};
        ...
        checkpointData = {
            {
                {0, uint256S("0xe7f5d84152a3bbc49b820663480163c41b8a18cf1ac586963d74d45ab4f947d3")},
            }
        };
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1777778888, 160752, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xb3f430804bd7e3f1da9ab697ecdb41422cff42137ef69146985eb0397a9e4542"));
        assert(genesis.hashMerkleRoot == uint256S("0x8cd85cfdc23bc43532f3139370921b4f12e085fe6ef3b18162c7317cb689ce5a"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        vSeeds.emplace_back("testnet-seed1.tg11.org");
        vSeeds.emplace_back("testnet-seed2.tg11.org");
        ...
        checkpointData = {
            {
                {0, uint256S("b3f430804bd7e3f1da9ab697ecdb41422cff42137ef69146985eb0397a9e4542")}
            }
        };
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        genesis = CreateGenesisBlock(1777779999, 0, 0x207fffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xc87438759241b107109a62c36278b2df4e12eab9e82889e4bdbf9f5e519c7bae"));
        assert(genesis.hashMerkleRoot == uint256S("0x8cd85cfdc23bc43532f3139370921b4f12e085fe6ef3b18162c7317cb689ce5a"));
        ...
        checkpointData = {
            {
                {0, uint256S("c87438759241b107109a62c36278b2df4e12eab9e82889e4bdbf9f5e519c7bae")},
            }
        };
